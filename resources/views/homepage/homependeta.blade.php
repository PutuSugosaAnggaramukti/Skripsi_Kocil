  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
                    ...
                    <a href="/" class="nav-item nav-link active">Home</a>
                        <div class="dropdown">
                            <a href="" class="nav-item nav-link">Input Jadwal</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/katekisasi">Input Jadwal Ibadah</a></li>
                                <li><a class="dropdown-item" href="/katekisasi">Input Jadwal Katekisasi</a></li>
                                <li><a class="dropdown-item" href="/baptis">Input Jadwal Baptis</a></li>
                                <li><a class="dropdown-item" href="/nikah">Input Jadwal Pemberkatan Nikah</a></li>
                            </ul>
                        </div>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        ...
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="display-5 text-white animated slideInLeft">Website Pendeta GKE Sinta Kuala Kapuas</p>
                            <p class="text-white animated slideInLeft mb-4 pb-2">Terdapat Layanan Seperti</p>
                            <p class="text-white animated slideInLeft mb-3 pb-1">Input Ibadah Syukur, Baptis Anak, Pemberkatan Nikah, Katekisasi dan Cek Jadwal</p>
                        </div>
                        <!-- <div id="calendar"> -->
